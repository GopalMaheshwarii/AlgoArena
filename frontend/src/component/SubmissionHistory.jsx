...
const SubmissionHistory = ({ problemId,code,setcode,setactiveTabCode,activeTabCode}) => {
            ...
            <div className="mb-4">
              ...
              <div className="flex flex-wrap gap-2 mb-2">
                ...
                <span className="badge badge-outline">
                  ...
                  <div><button className="btn btn-neutral btn-dash transform scale-75"  onClick={() => {
                      setcode(selectedSubmission?.code);
                      setactiveTabCode(selectedSubmission?.language)
                    }}>Transfer code to editor </button></div>
              </div>
